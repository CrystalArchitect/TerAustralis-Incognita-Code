...
Belt-Three law is enforced exactly as in-process: the hub validates every
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Boot the bridge (Starline Weaver server)")
    ...
    try:
        ...
        print("\nThe bridge rests. The sisters remain.")
    return 0
