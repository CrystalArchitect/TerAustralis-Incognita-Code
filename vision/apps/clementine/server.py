...
def create_app(companion: CrystalCore) -> Flask:
    ...
    def profile_switch():
        ...
        old = holder["c"]
        holder["c"] = CrystalCore(model=old.model, memory_dir=target,
...
def main():
    ...
    companion = CrystalCore(model=args.model, memory_dir=args.memory_dir)
